...
foreign import ccall "foreign/senna.h senna_get_number_of_tokens" c_senna_get_number_of_tokens :: CSenna -> IO CInt
foreign import ccall "foreign/senna.h senna_get_number_of_verbs" c_senna_get_number_of_verbs  :: CSenna -> IO CInt
foreign import ccall "foreign/senna.h senna_get_tokens" c_senna_get_tokens  :: CSenna -> IO (Ptr CString)
